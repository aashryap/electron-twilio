...
export const Controls  = ({
    ...
    return (
        <div className="flex items-center justify-center p-4 bg-blue-100 h-full rounded">
            ...
            <ControlButton icon={'fa-comment-alt'} onClick={()=>{}} className={`mx-2`} label={"Chat"}/>
            <ControlButton icon={'fa-phone-slash'} onClick={onCallDisconnect} className={`mx-2 text-red-500`} label={"Leave"}/>
        </div>
    )
};